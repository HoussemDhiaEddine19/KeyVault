...
#[derive(Debug)]
pub struct KeyVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KeyVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KeyVault processing");
    
    let mut processor = KeyVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KeyVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KeyVaultProcessor::new(false);
